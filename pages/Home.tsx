    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="relative min-h-[calc(100dvh-5rem)] flex items-center overflow-hidden py-20 sm:py-28 lg:py-32">
        <div className="absolute inset-0 z-0">
          ...
          {/* Balanced gradient overlay for premium legibility */}
        ...
        <div className="container mx-auto px-6 sm:px-12 lg:px-24 relative z-10">
          <div className="max-w-4xl space-y-4 md:space-y-6 lg:space-y-8">
            {/* Location Badge */}
            <div className="inline-flex items-center space-x-2 rtl:space-x-reverse bg-[#E2352B] px-3 md:px-5 py-1.5 rounded-full text-white text-[10px] md:text-xs font-black uppercase tracking-widest shadow-xl">
              <span className="h-2 w-2 rounded-full bg-white animate-pulse"></span>
              <span>{isEn ? 'Now Open in Jeddah' : 'مفتوح الآن في جدة'}</span>
            </div>
            
            {/* Main Headline - Scaled Down for Fullscreen Balance */}
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white leading-[0.95] md:leading-[0.85] tracking-tight uppercase drop-shadow-2xl">
              {isEn ? (
                <>
            ...
            {/* Sub-headline - Readable & Well-Spaced */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-100 font-bold max-w-2xl leading-relaxed drop-shadow-md">
              {isEn 
            ...
            {/* CTA Buttons - Professional Padding & Layout */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-6 md:pt-10">
              <button 
                onClick={() => onNavigate(Page.Contact)}
                className="px-8 py-4 md:px-12 md:py-5 bg-[#E2352B] text-white rounded-xl text-lg font-black uppercase tracking-widest shadow-[0_20px_40px_-10px_rgba(226,53,43,0.5)] transition-all hover:scale-105 hover:brightness-110 active:scale-95 text-center"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div 
                key={idx} 
                className="group flex flex-col items-center text-center p-8 lg:p-12 bg-white/5 border border-white/10 rounded-[2.5rem] hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 shadow-2xl"
              >
                <div className="mb-8 w-20 h-20 bg-[#E2352B] rounded-2xl flex items-center justify-center rotate-3 group-hover:rotate-12 transition-transform shadow-xl shadow-red-600/20">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-2 md:space-x-3 rtl:space-x-reverse bg-slate-50 p-4 rounded-2xl border border-slate-100 shadow-sm">
                    <i className={`fas ${item.icon} text-[#E2352B]`}></i>
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="relative z-10 rounded-[3rem] md:rounded-[4rem] overflow-hidden rotate-2 shadow-2xl border-[10px] md:border-[15px] border-white">
                <img 
              ...
              <div className="absolute top-1/2 -left-6 md:-left-10 -translate-y-1/2 bg-[#E2352B] text-white p-5 md:p-8 rounded-2xl md:rounded-[2rem] shadow-2xl z-20 -rotate-12 hidden sm:block">
      ...
      <section className="py-24 md:py-32 bg-[#E2352B] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
           ...
           <button 
             onClick={() => onNavigate(Page.Contact)}
             className="px-12 py-5 md:px-20 md:py-7 bg-white text-[#E2352B] rounded-2xl text-xl md:text-3xl font-black shadow-2xl hover:scale-105 active:scale-95 transition-all uppercase tracking-widest"
           >
